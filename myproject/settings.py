...
# Database configuration - use PostgreSQL in production, SQLite in development/fallback
...
# Email configuration - Brevo backend with console fallback
...
print("Using Brevo email backend with console fallback")
